...
public class PontoDSIFTDAO extends DAOGeneric implements DAO<Ponto> {
	...
	public void criarTabela() throws ClassNotFoundException, SQLException
	{
		...
		String sql =    "CREATE TABLE pontoDSIFT(" +
                            "   id SERIAL,\n" +
	...
	public void insert(Ponto obj) throws SQLException, ClassNotFoundException {
		...
		this.createStatement();
                ...
                String sql = "  INSERT INTO pontoDSIFT(imgid, x, y, featurevector) "
                        +   "   VALUES ("
                        +   obj.getImgId()
                        +   ","+obj.getX()
                        +   ","+obj.getY()
